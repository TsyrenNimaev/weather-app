...
export const HeaderLogo = () => {
  return (
    <div className={styles.headerlogo__wrapper}>
      <div className={styles.weather__icon}>
        <svg width="60" height="59" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className={styles.clock__icon}>
        <svg
          id="Layer_1"
          width="73"
          hanging="73"
        ...
        >
          <circle fill="#589FFF" cx="64" cy="64" r="50" />
          <circle
            fill="none"
            stroke="#242C88"
            strokeWidth="2"
          ...
          />
          <circle fill="#ffffff" cx="64" cy="64" r="40" />
          ...
          <circle
            ...
            r="40"
          />
          <circle fill="#FFC408" cx="64" cy="64" r="5.7" />
          <circle
            fill="none"
            stroke="#242C88"
            strokeWidth="2"
